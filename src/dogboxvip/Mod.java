...
public interface Mod
{
     ...
     * eg. Friends.java, getName returns "Friends"
     * @return
     * String - name of class
     */
    public String getName();

    /** sends message for each available command for this module
     * using sendMessage(sender, <String of command>
     */
